...
Curso.create([{id_curso: 'MATUTINO1', nombre: 'prepolitecnico1', duracion:30, materium_id:1, profesor_id:1},
{id_curso: 'MATUTINO2', nombre: 'prepolitecnico2', duracion:30, materium_id:2, profesor_id:2},
{id_curso: 'MATUTINO3', nombre: 'serbachiller1', duracion:30, materium_id:3, profesor_id:3},
{id_curso: 'VESPERTINO1', nombre: 'prepolitecnico3', duracion:30, materium_id:6, profesor_id:4},
{id_curso: 'VESPERTINO2', nombre: 'serbachiller2', duracion:30, materium_id:5, profesor_id:5},
{id_curso: 'VESPERTINO3', nombre: 'prepolitecnico4', duracion:30, materium_id:4, profesor_id:1}])
